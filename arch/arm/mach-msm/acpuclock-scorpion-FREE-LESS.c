...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 422400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0B, 0, 950, 117000 },
	{ 460800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0C, 0, 950, 117000 },
	{ 499200, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0D, 0, 975, 117000 },
	{ 537600, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0E, 0, 1000, 117000 },
	...
	{ 998400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1A, 0, 1175, 128000 },
	{ 1036800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1B, 0, 1200, 128000 },
	{ 1075200, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1C, 0, 1200, 128000 },
	{ 1113600, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1D, 0, 1250, 128000 },
	{ 1152000, CCTL(CLK_TCXO, 1),    	SRC_SCPLL, 0x1E, 0, 1250, 128000 },
	{ 1190400, CCTL(CLK_TCXO, 1),    	SRC_SCPLL, 0x1F, 0, 1250, 128000 },
