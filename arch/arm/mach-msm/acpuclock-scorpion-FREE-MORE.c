...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 245000, CCTL(CLK_MODEM_PLL, 1), 	SRC_RAW, 0, 0, 900, 29000 },
	/* Work arround for acpu resume hung, GPLL is turn off by arm9 */
	/*{ 256000, CCTL(CLK_GLOBAL_PLL, 3), SRC_RAW, 0, 0, 1050, 29000 },*/
	{ 384000, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0A, 0, 900, 58000 },
	{ 422400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x0B, 0, 900, 117000 },
	...
	{ 652800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x11, 0, 975, 117000 },
	{ 691200, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x12, 0, 1000, 117000 },
	{ 729600, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x13, 0, 1050, 117000 },
	{ 768000, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x14, 0, 1050, 128000 },
	{ 806400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x15, 0, 1075, 128000 },
	{ 844800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x16, 0, 1075, 128000 },
	{ 883200, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x17, 0, 1100, 128000 },
	{ 921600, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x18, 0, 1125, 128000 },
	{ 960000, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x19, 0, 1125, 128000 },
	{ 998400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1A, 0, 1125, 128000 },
	{ 1036800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1B, 0, 1150, 128000 },
	{ 1075200, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1C, 0, 1150, 128000 },
	{ 1113600, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1D, 0, 1200, 128000 },
	{ 1152000, CCTL(CLK_TCXO, 1),    	SRC_SCPLL, 0x1E, 0, 1200, 128000 },
	{ 1190400, CCTL(CLK_TCXO, 1),    	SRC_SCPLL, 0x1F, 0, 1200, 128000 },
        { 1228800, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x20, 0, 1250, 128000 },
	{ 0 },
};
